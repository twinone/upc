...
def main():
    ...
    try:
        date = literal_eval(args.date) if args.date else ''
    except:
    ...
    """.format(
        "Details",
        "Bicing Stations<br>with free slots",
        "Bicing Stations<br>with available bikes",
        "Public Parkings<br>with free spots"
    )
